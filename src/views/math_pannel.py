...
def math_pannel(parent, x, y):
    ...
    CalcButton("win", "e", "#ABA9A9", 3, 1, func.press_e).place(width=65, height=42, x=x + 170, y=y + 160)
    ...
    CalcButton("win", "log", "#ABA9A9", 3, 1, func.press_ln).place(width=65, height=42, x=x + 20, y=y + 310)
