...
def plot(func, xpoints, color_name, xlabel, ylabel, gui, line_style, file_path, discrete=False):
    ...
    # except Exception:
    #     print("Ошибка построения графика.")
...
def plot_line(arrays, color_name, xlabel, ylabel, gui, line_style, file_path):
...
def plot_dot(xyval, color_name, xlabel, ylabel, gui, dot_style, file_path):
